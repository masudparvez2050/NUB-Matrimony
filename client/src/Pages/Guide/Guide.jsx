...
const itemsEn = [
  ...
  },
  {
    ...
    content:
      "After viewing the contact information of your biodata through the Connection, if you want to make a complaint about that biodata to NUB Metrimony. <br> 1. Click on the Report button at the bottom of the biodata page. <br> 2. Next, submit the complaint-related information in the form on the next page. <br> Customer Care will verify it and take proper actions and inform you shortly in sha Allah.",
  },
  {
